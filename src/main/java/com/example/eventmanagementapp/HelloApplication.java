...
import com.example.eventmanagementapp.events.*;
...
public class HelloApplication extends Application {
            ...
            if (buttonType == ButtonType.OK) {
                try {
                    ...
                    if (type.equals("Workshop")) {
                        newEvent = new Workshop(eventId, title, dateTime, location, capacity, "Active", extra);
                    } else if (type.equals("Seminar")) {
                        newEvent = new Seminar(eventId, title, dateTime, location, capacity, "Active", extra);
                    } else if (type.equals("Concert")) {
                        newEvent = new Concert(eventId, title, dateTime, location, capacity, "Active", extra);
                    }
    ...
    private void searchByTitle() {
        ...
        dialog.showAndWait().ifPresent(keyword -> {
            ArrayList<Event> results = eventManager.searchByTitle(keyword.trim());
    ...
    private void filterByType() {
        ...
        dialog.showAndWait().ifPresent(type -> {
            ArrayList<Event> results = eventManager.filterByType(type);
        ...
        dialog.showAndWait().ifPresent(buttonType -> {
            if (buttonType == ButtonType.OK) {
                try {
                    ...
                    if (updated) {
                        outputArea.setText("Event updated successfully for ID: " + eventId);
                    } else {
                        outputArea.setText("Event not found for ID: " + eventId);
                    }
